...
urlpatterns = [
	...
	path('non-exist',NonExistView.as_view(),name="non_exist"),
	...
	path('history',HistoryLinksView.as_view(),name="history_view"),
	path('link/<pk>',LinksDeleteView.as_view(),name="delete_link"),
	path('delete-logo',LinksDeleteLogoView.as_view(),name="delete_logo"),
	...
	path('configuration/',ConfigurationView.as_view(),name="configuration_view"),
]